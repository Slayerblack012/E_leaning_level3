...
const extendedEssays = {
  ...
  math_12: [
    ...
    { q: "Giải phương trình mũ sau bằng phương pháp đặt ẩn phụ: 9^x - 4*3^x + 3 = 0. Sau đó, tính tổng các nghiệm tìm được.", level: "hard", sampleAnswer: "1. Đặt t = 3^x (điều kiện: t > 0). Phương trình trở thành phương trình bậc hai: t² - 4t + 3 = 0.\n2. Giải phương trình trên, ta được hai nghiệm t = 1 và t = 3 (đều thỏa mãn điều kiện t > 0).\n3. Với t = 1: 3^x = 1 => x = 0.\n4. Với t = 3: 3^x = 3 => x = 1.\n5. Phương trình có hai nghiệm phân biệt x = 0 và x = 1. Vậy tổng các nghiệm là 0 + 1 = 1." },
    { q: "Trong không gian Oxyz, cho đường thẳng d: (x-1)/2 = (y+1)/1 = z/-1 và mặt phẳng (P): x + y + z - 3 = 0. Tìm tọa độ giao điểm M của đường thẳng d và mặt phẳng (P).", level: "hard", sampleAnswer: "1. Chuyển phương trình đường thẳng d về dạng tham số: x = 1 + 2t, y = -1 + t, z = -t.\n2. Vì M là giao điểm của d và (P), thay tọa độ tham số của d vào phương trình mặt phẳng (P): (1 + 2t) + (-1 + t) + (-t) - 3 = 0.\n3. Rút gọn phương trình ta được: 2t - 3 = 0 => t = 3/2.\n4. Thay giá trị t = 3/2 vào phương trình tham số của d để tìm tọa độ M: x = 1 + 2*(3/2) = 4; y = -1 + 3/2 = 1/2; z = -3/2.\n5. Vậy tọa độ giao điểm M là (4; 1/2; -3/2)." }
  ],
  physics_12: [
